...
public class RunPlayOrm {

	private static final Logger log = LoggerFactory.getLogger(RunPlayOrm.class);
...
//		String testType = args[2];
		...
		if("writenojoin".equalsIgnoreCase(testType)) {
			...
			throw new IllegalArgumentException("Did not select one of the test types.  (just look at the if statement in this code for the possible values)");
		}
	}
